...
const RateProduct = () => {
  ...
  return (
    <div className="px-5 lg:px-20">
      {ratingSubmitted ? (
        <h1 className="text-center text-xl p-5 shadow-lg mb-8 font-bold">
      Thank you for rating! <FavoriteIcon color="error" />
      </h1>
      ) : (
        <>
           ...
           {customersProduct.product?.color && <p>Color: {customersProduct.product?.color}</p>}
            ...
            <div>
              <p className="space-y-2 font-semibold">
                ...
                />
                <span>Previously Purchased by you</span>{" "}
              </p>
            ...
            <Grid item xs={12} lg={6}>
              <div className={`${!isLargeScreen ? "py-10" : ""} space-y-5`}>
                ...
                <form
                  ...
                  className={`${
                    !isLargeScreen || ratingSubmitted ? "py-10" : ""
                  } space-y-5 p-5 shadow-md border rounded-md`}
                >
                  <TextField
                    label="Title"
                    variant="outlined"
